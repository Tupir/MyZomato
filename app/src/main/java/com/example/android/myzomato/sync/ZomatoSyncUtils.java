...
//      COMPLETED (4) If the method body is executed, set sInitialized to true
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            public Void doInBackground(Void... voids ) {
                 ...
                 * to determine what need to be displayed.
                 */
                String[] projectionColumns = {RestaurantTableContents.RestaurantEntry._ID};
                String selectionStatement = RestaurantTableContents.RestaurantEntry.COLUMN_ID + ">= 16514840";
    ...
    public static void startImmediateSync(@NonNull final Context context) {
        Intent intentToSyncImmediately = new Intent(context, ZomatoSyncIntentService.class);
